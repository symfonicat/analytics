...
PHP_FUNCTION(symfonicat_analytics_string_remove);

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_symfonicat_analytics_string_remove, 0, 2, IS_STRING, 0)
    ZEND_ARG_TYPE_INFO(0, value, IS_STRING, 0)
    ZEND_ARG_TYPE_INFO(0, needle, IS_STRING, 0)
ZEND_END_ARG_INFO()

static const zend_function_entry symfonicat_analytics_string_remove_functions[] = {
    PHP_FE(symfonicat_analytics_string_remove, arginfo_symfonicat_analytics_string_remove)
    PHP_FE_END
};

zend_module_entry symfonicat_analytics_module_entry = {
    STANDARD_MODULE_HEADER,
    "symfonicat_analytics",
    symfonicat_analytics_string_remove_functions,
    NULL,
    NULL,
    NULL,
    NULL,
...
ZEND_GET_MODULE(symfonicat_analytics)
